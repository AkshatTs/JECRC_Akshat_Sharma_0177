//Using Backend Console Application to display Employee data
    ...
    class Program
    {
        static void Main()
        {
            string connectionString =
                "Server=LAPTOP-0757V39V\\SQLEXPRESS;Database=SQL_Training;Trusted_Connection=True;TrustServerCertificate=True;";
